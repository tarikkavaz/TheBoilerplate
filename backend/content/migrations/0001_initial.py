    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lang', models.CharField(blank=True, choices=[('en', 'English'), ('tr', 'Turkish')], default='en', max_length=2, verbose_name='Language')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lang', models.CharField(blank=True, choices=[('en', 'English'), ('tr', 'Turkish')], default='en', max_length=2, verbose_name='Language')),
                ('images', models.ManyToManyField(blank=True, to='content.image', verbose_name='Select Images')),
